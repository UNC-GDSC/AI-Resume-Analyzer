...
from app.api.v1 import auth, jobs, resumes, rankings, analytics, batch, interview, search, diversity, ml, candidate_portal, audit, comparison
...
app.include_router(comparison.router, prefix="/api/v1/comparison", tags=["Resume Comparison"])
